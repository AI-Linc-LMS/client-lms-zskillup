 ...
 * Clicking a locked item opens a purchase prompt (the dynamic price drawer,
 * API-computed in production — never client-side).
 *
 ...
 *
 * The single visible-lock primitive for Phase 8 — every surface (Practice /
 * Section / Company hubs, assessments) renders locks through this so they look
 * identical and can never accidentally HIDE paid content or silently swallow a click.
 */
