...
export function PreviewBanner() {
  ...
  return (
    <div className="sticky top-14 z-20 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 border-b border-orange/30 bg-orange/10 px-6 py-2 text-center">
