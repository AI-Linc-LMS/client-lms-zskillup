              ...
              upcoming.map((it) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-2 flex w-full items-center justify-center gap-1.5 rounded-full border border-slate-200 px-3 py-1.5 text-[11px] font-bold text-slate-600 hover:bg-slate-50"
                  >
                      ...
                      {lb.entries.map((e) => (
                        ...
                        >
                          ...
                          <span className="min-w-0 flex-1 truncate text-sm font-semibold text-navy">
                            {e.name}
                            {e.isYou ? <span className="ml-1.5 text-[10px] font-bold text-orange">YOU</span> : null}
                          </span>
                          <span className="text-sm font-extrabold tabular-nums text-navy">{e.scorePct}%</span>
                        </li>
                      ))}
                    </ul>
                  )}
