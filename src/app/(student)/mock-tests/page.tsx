...
import { ArrowRight, Brain, CalendarDays, ShieldCheck, Sparkles } from 'lucide-react';
...
/**
 * Mock Quiz workspace — ADAPTIVE, AI-evaluated, non-proctored self-practice.
 * (Proctored company Assessments are scheduled and live on the Calendar.)
 */
export default function MockQuizPage() {
  return (
    <div>
      ...
      {/* Hero — AI adaptive (indigo/purple) */}
      <Reveal>
        <header className="relative isolate overflow-hidden rounded-[1.75rem] p-7 text-white shadow-[0_30px_90px_-32px_rgba(11,18,32,0.85)] sm:rounded-[2rem] sm:p-9">
          ...
          <div className="relative z-10 max-w-2xl">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.08] px-3 py-1.5 text-[11px] font-bold uppercase tracking-[0.16em] text-white/75 backdrop-blur">
              <Sparkles className="size-3.5 text-[#a78bfa]" />
              Adaptive · AI-evaluated
            </span>
            ...
            <p className="mt-3 max-w-xl text-[15px] leading-relaxed text-white/65 sm:text-base">
              Self-practice that adapts to every answer — the IRT engine targets your weak skills and
              an AI tutor breaks down your result with a personalised study path. Non-proctored.
            </p>
          </div>
        </header>
      </Reveal>
      ...
      <div className="mt-8 space-y-10">
        ...
        <Reveal>
          <section>
            <header className="mb-5">
              <p className="text-[11px] font-semibold uppercase tracking-widest text-slate-400">Practice</p>
              <h2 className="mt-1 flex items-center gap-2 text-xl font-extrabold tracking-tight text-navy sm:text-2xl">
                <Brain className="size-5 text-indigo-500" /> Adaptive quizzes
              </h2>
            </header>
        ...
        <Reveal>
          <section>
            <header className="mb-5">
              <p className="text-[11px] font-semibold uppercase tracking-widest text-slate-400">Proctored</p>
              <h2 className="mt-1 flex items-center gap-2 text-xl font-extrabold tracking-tight text-navy sm:text-2xl">
            ...
            <Link
              href="/calendar"
              className="group flex items-center justify-between gap-4 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md"
            >
