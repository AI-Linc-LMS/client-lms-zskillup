...
export default async function PracticePage({ searchParams }: PageProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <Reveal>
        <section data-tour="practice:hero" className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#0a0a0c] via-[#0d0e13] to-[#141a2e] p-6 text-white sm:p-8">
