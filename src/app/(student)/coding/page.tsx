...
export default async function CodingPracticePage({ searchParams }: PageProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <Reveal>
        <section data-tour="coding:hero" className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#1f2d4d] via-[#16223f] to-[#0b1220] p-6 text-white shadow-sm sm:p-8">
