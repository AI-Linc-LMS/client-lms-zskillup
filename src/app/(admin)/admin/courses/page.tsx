...
export default function AdminCoursesPage() {
  return (
    <div className="space-y-6">
      ...
      <header>
        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Content</p>
        <h1 className="mt-1 text-[28px] font-extrabold tracking-tight text-navy">Courses</h1>
        <p className="mt-1 text-sm text-slate-500">Author courses, modules and lessons (video / text / concept reels).</p>
      </header>
