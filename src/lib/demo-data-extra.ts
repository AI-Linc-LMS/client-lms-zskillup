...
export const HOMEPAGE_FEATURED_TRACKS: HomepageTrack[] = [
  ...
  { slug: 'wipro', company: 'Wipro', type: 'SERVICE', logoSrc: `${wiki}/a/a0/Wipro_Primary_Logo_Color_RGB.svg`, logoAlt: 'Wipro logo', description: 'Aptitude, OOP and coding fundamentals for the Wipro NTH / Elite drives.', title: 'Wipro - Complete preparation', mcqs: '1.9k+', rounds: 4, rating: 4.5, enrolled: '10k+', hours: 12, accent: 'from-purple-600 to-fuchsia-700' },
  { slug: 'ibm', company: 'IBM', type: 'SERVICE', logoSrc: `${wiki}/5/51/IBM_logo.svg`, logoAlt: 'IBM logo', description: 'Cognitive ability games, coding and the IBM ASE / associate fresher track.', title: 'IBM - Complete preparation', mcqs: '1.6k+', rounds: 4, rating: 4.5, enrolled: '7k+', hours: 12, accent: 'from-blue-700 to-sky-800' },
];
