...
const GRAND_STEPS: GuideStep[] = [
  {
    ...
    body: "Take a quick tour of prephasz to discover where to practice, track your progress, and prepare for placements\u2014all in one place. You can skip or replay anytime.",
  },
  // \u2500\u2500 Chrome \u2500\u2500
  ...
  { id: 'chrome-streak', target: 'chrome:streak', placement: 'bottom', eyebrow: 'Momentum', title: 'Your Streak & XP', body: "Earn XP for every activity you complete and maintain your daily streak by practicing consistently. Stay motivated, level up faster, and climb the leaderboard." },
  { id: 'chrome-notifications', target: 'chrome:notifications', placement: 'bottom', eyebrow: 'Stay in the loop', title: 'Notifications', body: "Stay updated with assessment schedules, interview invites, results, live sessions, and important placement announcements\u2014all in one place." },
  { id: 'chrome-account', target: 'chrome:account', placement: 'bottom', eyebrow: 'Your account', title: 'Profile & Settings', body: "Manage your profile, update your details, customize your settings, and access your account preferences from here." },
  ...
  { id: 'nav-performance', target: nav('/performance'), placement: 'right', desktopOnly: true, eyebrow: 'Workspace', title: 'Performance', body: "Track your progress across aptitude, coding, communication, and other skills. The platform analyzes your strengths and improvement areas, helping you focus on the skills that matter most." },
  ...
  { id: 'nav-practice', target: nav('/practice'), placement: 'right', desktopOnly: true, eyebrow: 'Practice', title: 'Adaptive Practice', body: "Adaptive Practice is a non-proctored, AI-powered learning mode that adjusts the difficulty of questions based on your performance. As you improve, the platform challenges you with harder questions while helping you strengthen concepts where needed." },
  { id: 'nav-practice-wish', target: nav('/practice-wish'), placement: 'right', desktopOnly: true, eyebrow: 'Practice', title: 'Non-Adaptive Practice', body: "Non-Adaptive Practice is a non-proctored practice mode that provides AI-curated practice sets with a fixed difficulty level. With unlimited questions, you can practice continuously to strengthen your concepts and improve your confidence." },
  { id: 'nav-mock-assessment', target: nav('/mock-assessment'), placement: 'right', desktopOnly: true, eyebrow: 'Assessment', title: 'Mock Assessments', body: "Mock Assessments are AI-proctored practice tests that simulate real placement exams with company-like question patterns, time limits, and scoring. Practice in a secure exam environment to improve your speed, accuracy, and confidence." },
  { id: 'nav-assessments', target: nav('/assessments'), placement: 'right', desktopOnly: true, eyebrow: 'Assessment', title: 'Assessments', body: "Assessments are AI-proctored tests assigned by your college, training partner, or recruiters to evaluate your skills and track your progress in a secure assessment environment." },
  { id: 'nav-resume', target: nav('/resume-builder'), placement: 'right', desktopOnly: true, eyebrow: 'Career', title: 'Resume Builder', body: "Create a professional, ATS-friendly resume using guided templates that showcase your skills and improve your chances of getting shortlisted." },
  { id: 'nav-mock-interview', target: nav('/mock-interview'), placement: 'right', desktopOnly: true, eyebrow: 'Career', title: 'Mock Interviews', body: "Mock Interviews are AI-proctored interview simulations that help you prepare for HR, technical, and aptitude interviews. Practice in a secure environment and receive feedback to improve your interview performance." },
  { id: 'nav-certificates', target: nav('/certificates'), placement: 'right', desktopOnly: true, eyebrow: 'Career', title: 'Certificates', body: "Access and download the certificates you've earned through assessments, achievements, and platform activities to showcase your accomplishments." },
  { id: 'nav-company', target: nav('/dashboard/company'), placement: 'right', desktopOnly: true, eyebrow: 'Explore', title: 'Company Hubs', body: "Company Hubs provide company-specific preparation with aptitude questions, coding challenges, interview experiences, and learning resources to help you prepare for your target companies." },
  { id: 'nav-section', target: nav('/dashboard/section'), placement: 'right', desktopOnly: true, eyebrow: 'Explore', title: 'Sectional Hubs', body: "Sectional Hubs give you section-by-section prep \u2014 syllabus, study material, and topic-wise practice for each section. Unlock a single topic or the whole section." },
